          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Theme Options', 'pulse' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Theme Options', 'pulse' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'pulse' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'pulse' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'pulse' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'pulse' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => esc_html__( 'OptionTree', 'pulse' ),
        'menu_title'      => esc_html__( 'OptionTree', 'pulse' ),
      ...
      array(
        ...
        'page_title'      => esc_html__( 'Settings', 'pulse' ),
        'menu_title'      => esc_html__( 'Settings', 'pulse' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => esc_html__( 'Theme Options updated.', 'pulse' ),
        'reset_message'   => esc_html__( 'Theme Options reset.', 'pulse' ),
        'button_text'     => esc_html__( 'Save Settings', 'pulse' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => esc_html__( 'Theme Options UI', 'pulse' )
          ),
          array(
            'id'          => 'import',
            'title'       => esc_html__( 'Import', 'pulse' )
          ),
          array(
            'id'          => 'export',
            'title'       => esc_html__( 'Export', 'pulse' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => esc_html__( 'Layouts', 'pulse' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => esc_html__( 'Theme Options UI Builder', 'pulse' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => esc_html__( 'Settings XML', 'pulse' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => esc_html__( 'Settings', 'pulse' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => esc_html__( 'Theme Options', 'pulse' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => esc_html__( 'Layouts', 'pulse' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => esc_html__( 'Settings PHP File', 'pulse' ),
          ...
          array(
            ...
            'label'       => esc_html__( 'Layout Management', 'pulse' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => esc_html__( 'Documentation', 'pulse' ),
        'menu_title'      => esc_html__( 'Documentation', 'pulse' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => esc_html__( 'Creating Options', 'pulse' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => esc_html__( 'Option Types', 'pulse' )
          ),
          array(
            'id'          => 'functions',
            'title'       => esc_html__( 'Function References', 'pulse' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => esc_html__( 'Theme Mode', 'pulse' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => esc_html__( 'Meta Boxes', 'pulse' )
          ),
          array(
            'id'          => 'examples',
            'title'       => esc_html__( 'Code Examples', 'pulse' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => esc_html__( 'Layouts Overview', 'pulse' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => esc_html__( 'Overview of available Theme Option fields.', 'pulse' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'pulse' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => esc_html__( 'Function Reference:ot_get_option()', 'pulse' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => esc_html__( 'Function Reference:get_option_tree()', 'pulse' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => esc_html__( 'Theme Mode', 'pulse' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => esc_html__( 'Meta Boxes', 'pulse' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => esc_html__( 'Code examples for front-end development.', 'pulse' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => esc_html__( 'What\'s a layout anyhow?', 'pulse' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'option-tree', 'invalid_border_width', sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'pulse' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'option-tree', 'invalid_hex', sprintf( esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'pulse' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_dimension_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'pulse' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_spacing_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'pulse' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'pulse' ) ),
      'remove_media_text'     => esc_html__( 'Remove Media', 'pulse' ),
      'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'pulse' ),
      'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'pulse' ),
      'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'pulse' ),
      'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'pulse' ),
      'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'pulse' ),
      'delete'                => esc_html__( 'Delete Gallery', 'pulse' ), 
      'edit'                  => esc_html__( 'Edit Gallery', 'pulse' ), 
      'create'                => esc_html__( 'Create Gallery', 'pulse' ), 
      'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'pulse' ),
      'date_current'          => esc_html__( 'Today', 'pulse' ),
      'date_time_current'     => esc_html__( 'Now', 'pulse' ),
      'date_close'            => esc_html__( 'Close', 'pulse' ),
      'replace'               => esc_html__( 'Featured Image', 'pulse' ),
      'with'                  => esc_html__( 'Image', 'pulse' )
    );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'option-tree', array(
      'labels'              => array( 'name' => esc_html__( 'Option Tree', 'pulse' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => esc_html__( 'General', 'pulse' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => esc_html__( 'Sample Text Field Label', 'pulse' ),
              'desc'      => esc_html__( 'Description for the sample text field.', 'pulse' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'pulse' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'pulse' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'pulse' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'pulse' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'pulse' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'pulse' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'pulse' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'pulse' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'pulse' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'pulse' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'pulse' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'pulse' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'pulse'),
      'border'                    => esc_html__('Border', 'pulse'),
      'box-shadow'                => esc_html__('Box Shadow', 'pulse'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'pulse'),
      'category-select'           => esc_html__('Category Select', 'pulse'),
      'checkbox'                  => esc_html__('Checkbox', 'pulse'),
      'colorpicker'               => esc_html__('Colorpicker', 'pulse'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'pulse'),
      'css'                       => esc_html__('CSS', 'pulse'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'pulse'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'pulse'),
      'date-picker'               => esc_html__('Date Picker', 'pulse'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'pulse'),
      'dimension'                 => esc_html__('Dimension', 'pulse'),
      'gallery'                   => esc_html__('Gallery', 'pulse'),
      'google-fonts'              => esc_html__('Google Fonts', 'pulse'),
      'javascript'                => esc_html__('JavaScript', 'pulse'),
      'link-color'                => esc_html__('Link Color', 'pulse'),
      'list-item'                 => esc_html__('List Item', 'pulse'),
      'measurement'               => esc_html__('Measurement', 'pulse'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'pulse'),
      'on-off'                    => esc_html__('On/Off', 'pulse'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'pulse'),
      'page-select'               => esc_html__('Page Select', 'pulse'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'pulse'),
      'post-select'               => esc_html__('Post Select', 'pulse'),
      'radio'                     => esc_html__('Radio', 'pulse'),
      'radio-image'               => esc_html__('Radio Image', 'pulse'),
      'select'                    => esc_html__('Select', 'pulse'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'pulse'),
      'slider'                    => esc_html__('Slider', 'pulse'),
      'social-links'              => esc_html__('Social Links', 'pulse'),
      'spacing'                   => esc_html__('Spacing', 'pulse'),
      'tab'                       => esc_html__('Tab', 'pulse'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'pulse'),
      'tag-select'                => esc_html__('Tag Select', 'pulse'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'pulse'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'pulse'),
      'text'                      => esc_html__('Text', 'pulse'),
      'textarea'                  => esc_html__('Textarea', 'pulse'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'pulse'),
      'textblock'                 => esc_html__('Textblock', 'pulse'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'pulse'),
      'typography'                => esc_html__('Typography', 'pulse'),
      'upload'                    => esc_html__('Upload', 'pulse')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => esc_html__( 'Left Sidebar', 'pulse' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => esc_html__( 'Right Sidebar', 'pulse' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => esc_html__( 'Full Width (no sidebar)', 'pulse' ),
...
if ( ! function_exists( 'ot_list_item_settings' ) ) {
  ...
  function ot_list_item_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_list_item_settings', array(
      ...
      array(
        'id'        => 'description',
        'label'     => esc_html__( 'Description', 'pulse' ),
        'desc'      => '',
        'std'       => '',
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        'id'        => 'name',
        'label'     => esc_html__( 'Name', 'pulse' ),
        'desc'      => esc_html__( 'Enter the name of the social website.', 'pulse' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => esc_html__( 'Enter the text shown in the title attribute of the link.', 'pulse' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'pulse' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'option-tree', 'dynamic_css', sprintf( esc_html__( 'Unable to write to file %s.', 'pulse' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'pulse' ) . '">
          <span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'pulse' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'pulse' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'pulse' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . wp_kses(__( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'pulse' ),array('strong'=>array())) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . wp_kses(__( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'pulse' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Settings</strong>: This will only affect the List Item option type.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'pulse' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'pulse' ),array('strong'=>array(),'code'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . wp_kses(__( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . wp_kses(__( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'pulse' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'pulse' ) . '</option>
              </select>
            </div>
          </div>
        </div>
  ...
  function ot_choices_view( $name, $key, $choice = array() ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Image Source (Radio Image only)', 'pulse' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . wp_kses(__( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . wp_kses(__( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'pulse' ),array('strong'=>array())) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'pulse' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'pulse' ) . '">
          <span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'pulse' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. esc_html__( 'Delete', 'pulse' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'pulse' ) . '
        </a>
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'pulse' ) . '">' . esc_html__( 'New Layout', 'pulse' ) . '</button>';
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_gallery', array(
    ...
    'title'     => esc_html__( 'Gallery', 'pulse' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
  ...
  return apply_filters( 'ot_meta_box_post_format_link', array(
    ...
    'fields'    => array(
      array(
        'id'      => '_format_link_url',
        'label'   => '',
        'desc'    => esc_html__( 'Link URL', 'pulse' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Link Title', 'pulse' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Name (ex. author, singer, actor)', 'pulse' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source URL', 'pulse' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Title (ex. book, song, movie)', 'pulse' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Date', 'pulse' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'pulse' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'pulse' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'pulse' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'pulse' ) .'</a>', '<code>[audio]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
