...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name'               => 'PULSE CPT', // The plugin name.
            'slug'               => 'pulse-cpt', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/inc/plugins/pulse-cpt.zip', // The plugin source.
     ...
     */
    $config = array(
        'id'           => 'pulse-tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
